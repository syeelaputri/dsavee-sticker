...
const features = [
  ...
  },
  {
    ...
    text: "Setiap transaksi dijamin aman dengan sistem pembayaran terenkripsi",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="32"
  ...
  },
  {
    ...
    text: "Setiap stiker dicetak dengan bahan premium tahan air dan tidak mudah pudar",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="32"
  ...
  },
  {
    ...
    text: "Harga terbaik setiap hari dengan promo eksklusif untuk pelanggan setia kami",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="32"
  ...
  return (
    <section className="py-5 features-section">
      <div className="container-fluid">
        <div className="row features-row-nowrap g-3">
          {features.map((f, i) => (
            <div className="col" key={i}>
              <article className="card feature-card mb-3 border-0 h-100">
                <div className="row g-2 align-items-center">
                  <div className="col-auto text-dark feature-icon-col">
                  ...
                  <div className="col">
                    <div className="card-body p-0">
                      <h5 className="feature-title mb-1">{f.title}</h5>
                      <p className="card-text feature-text mb-0">{f.text}</p>
                    </div>
                  </div>
                </div>
              </article>
